...
#Generate adn draw classic networks
G0 = nx.path_graph(20)
...
names = ("Linear (path)", "Ring (Cycle)", "Balanced Tree", "Mesh (Grid)", "Star", "Complete")
...
dzcnapy.plot("syntetic2")

#We will need the network of Southern women agein!
