...
attrs ={"edge_color" : "gray", "node_color": "pink", "node_size": 50, "width": 2,}
...
nx.set_edge_attributes(ergraph, {(n1, n2): random.random() for n1, n2 in ergraph.edges()}, "weight")
...
for i, threshold in enumerate([0, 0.7, 0.8, 0.9, 0.95, 1.0]):
    ...
    nx.draw_networkx_edges(ergraph, pos, alpha=0.65, ax=ax, **dzcnapy.small_attrs)
